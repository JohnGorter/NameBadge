...
var template = `
    <style>
         ...
         .gridcontainer { position:absolute;display:flex;flex-direction:row;justify-content:center;flex-wrap:wrap;}
        ...
        .item-row[focus] { z-index:10; outline: 0px solid #71d1a4;opacity:1.0 }
        ...
        .item   {transition:all 0.2s ease-in-out; min-width:50px;min-height:50px;margin:5px;opacity:0.5;}
        .item[focus] {z-index:10; outline: 0px solid #71d1a4;opacity:1.0 }
