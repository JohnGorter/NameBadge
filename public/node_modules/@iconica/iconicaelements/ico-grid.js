...
var template = `
    <style>
        ...
        .item-b { grid-area: main;max-width:100%;max-height:100%;}
        .item-c { grid-area: second;max-width:100%;max-height:100%;}
        .item-d { grid-area: third;max-width:100%;max-height:100%;}
        .item-e { grid-area: fourth;max-width:100%;max-height:100%;}
        .item-f { grid-area: fifth;max-width:100%;max-height:100%;}
        .item   {transition:all 0.2s ease-in-out; margin:5px;}
