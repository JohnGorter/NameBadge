...
var template = `
    <style>
         .gridcontainer { position:absolute;display:flex;justify-content:center;flex-direction:row;flex-wrap:wrap;}
        ...
        .item   {transition:all 0.2s ease-in-out;min-width:50px;min-height:50px;}
        .item[focus] {box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);}
