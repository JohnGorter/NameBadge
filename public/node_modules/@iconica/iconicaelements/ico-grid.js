...
var template = `
    <style>
        ...
        .item-row { flex:1;background-color:coral;margin:5px;transition:all 0.2s;}
        .item-row[focus] { z-index:10; outline: 5px solid}

        div { }
        .item-n {min-width:50px;min-height:50px}
        .item-b { grid-area: main;}
        .item-c { grid-area: second;}
        .item-d { grid-area: third;}
        .item-e { grid-area: fourth;}
        .item-f { grid-area: fifth;}
        .item   {transition:all 0.2s ease-in-out;margin:5px;opacity:0.5;}
        .item[focus] {z-index:10; opacity:1;}
