...
const htmlTemplate = `
   ...
   .pagecontainer p { font-size:4vw;line-height:1.5;}
   ...
   div[step3] .pagecontainer { background-color:#f5f5f5}
   ...
   ico-wizard.page3 { width:100vw;background-color:#f5f5f5;}
   paper-fab { position:fixed;right:20px;bottom:20px;background-color:#454545;opacity:0.7;}
   .scanner_container { border: 1px solid white; border-right: 1px solid gray; border-bottom: 1px solid gray;background-color:white;}
   </style>
   <div class="container">
